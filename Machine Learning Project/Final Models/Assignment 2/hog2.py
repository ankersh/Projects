...
for i in range(0, len(imagelist)):
    ...
    h = hog(rawimage,pixels_per_cell=(4, 4))
...
Xtrain, Xtest, Ytrain, Ytest = train_test_split(trainimages, labels, test_size=0.50,random_state=10)          #Splits training data randomly
