...
model.add(Convolution2D(32, 3, 3,border_mode='same',dim_ordering='th'))         #Layer 1: Simple Convolution2D with 32 output filters and relu activation
model.add(Activation('relu'))
...
model.add(Convolution2D(128, 3, 3,border_mode='same', dim_ordering='th'))                            #Layer 3: Simple Convolution2D with 128 output filters and relu activation
model.add(Activation('relu'))
model.add(Convolution2D(128, 3, 3,border_mode='same', dim_ordering='th'))                            #Layer 3: Simple Convolution2D with 128 output filters and relu activation
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
