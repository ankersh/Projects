...
Xtrain, Xtest, Ytrain, Ytest = train_test_split(images, labels, test_size=0.2,random_state=10)          #Splits training data randomly
...
mlp = MLPClassifier(hidden_layer_sizes=(11016),max_iter=180,verbose=True,tol=0.00004)
